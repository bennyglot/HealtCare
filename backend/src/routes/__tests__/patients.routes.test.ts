...
describe("Patients API", () => {
  it.skip("GET /patients should return a list of patients", async () => {
    const res = await request(app).get("/api/patients");
    expect(res.statusCode).toBe(200);
  });

  it.skip("GET /patients/:patientId should return a patient or 404", async () => {
  ...
  it.skip("GET /patients/:patientId/:testId should return lab results or 404", async () => {
    const patientId = "7792223"; // Replace with a real or mock ID
